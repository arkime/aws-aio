        ...
        mock.call(
            ...
            context={
                ...
                constants.CDK_CONTEXT_PARAMS_VAR: shlex.quote(json.dumps({
                    ...
                    "nameCaptureDetailsSsmParam": constants.get_capture_details_ssm_param_name(TEST_CLUSTER),
                    ...
                    "nameViewerDetailsSsmParam": constants.get_viewer_details_ssm_param_name(TEST_CLUSTER),
