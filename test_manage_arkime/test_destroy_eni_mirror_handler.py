...
def test_WHEN_DestroyEniMirrorHandler_handle_called_THEN_destroys_mirroring(mock_ec2i, mock_ssm_ops):
    # Set up our mock
    ...
    assert expected_put_calls == mock_ssm_ops.delete_ssm_param.call_args_list

@mock.patch("lambda_destroy_eni_mirror.destroy_eni_mirror_handler.AwsClientProvider", mock.Mock())
@mock.patch("lambda_destroy_eni_mirror.destroy_eni_mirror_handler.ssm_ops")
@mock.patch("lambda_destroy_eni_mirror.destroy_eni_mirror_handler.ec2i")
def test_WHEN_DestroyEniMirrorHandler_handle_called_AND_session_doesnt_exist_THEN_handles_gracefully(mock_ec2i, mock_ssm_ops):
    # Set up our mock
