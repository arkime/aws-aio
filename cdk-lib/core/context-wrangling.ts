    ...
    switch (args.managementCmd) {
        ...
        case ManagementCmd.DestroyCluster:
            ...
            const clusterMgmtParams: prms.ClusterMgmtParams = {
                ...
                nameCaptureConfigSsmParam: rawClusterMgmtParamsObj.nameCaptureConfigSsmParam,
                nameCaptureDetailsSsmParam: rawClusterMgmtParamsObj.nameCaptureDetailsSsmParam,
                nameClusterConfigBucket: rawClusterMgmtParamsObj.nameClusterConfigBucket,
                ...
                nameViewerConfigSsmParam: rawClusterMgmtParamsObj.nameViewerConfigSsmParam,
                nameViewerDetailsSsmParam: rawClusterMgmtParamsObj.nameViewerDetailsSsmParam,
                planCluster:  JSON.parse(rawClusterMgmtParamsObj.planCluster),
                stackNames: JSON.parse(rawClusterMgmtParamsObj.stackNames),
