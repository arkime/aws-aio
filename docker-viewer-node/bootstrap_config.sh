...
echo "Retrieving config details from SSM Parameter $VIEWER_CONFIG_SSM_PARAM"
param_value=$(aws ssm get-parameter --name "$VIEWER_CONFIG_SSM_PARAM" --query Parameter.Value)
